package com.example.application.views.employmentwizard.personform;
...
@Route(value = "person-step", layout = EmploymentWizardView.class)
...
public class PersonFormView extends Div {
    ...
    private Button next = new Button("Next", e -> e.getSource().getUI().ifPresent(ui -> ui.navigate(ExperienceFormView.class)));
