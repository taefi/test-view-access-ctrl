...
public class MainView extends AppLayout {
    ...
    private Component createHeaderContent() {
        ...
        if (user != null) {
            ...
            layout = new HorizontalLayout(new DrawerToggle(), viewTitle, new Avatar(), logout);
        } else {
            layout = new HorizontalLayout(new DrawerToggle(), viewTitle, new Avatar());
        }
        layout.setId("header");
    ...
    private Component[] createMenuItems() {
        return new Tab[]{createTab("Master-Detail", MasterDetailView.class),
                createTab("Employment Wizard", EmploymentWizardView.class),
